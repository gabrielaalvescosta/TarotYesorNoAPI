...
const ADD_DADOS_CARDS = `INSERT INTO CARDS
        ...
        ('./major-arcana/17-TheStar.png', '17 - A Estrela', 'Sim', 'Lorem estrela'),
        ('./major-arcana/18-TheMoon.png', '18 - A Lua', 'Não', 'Explicacao a lua'),
        ('./major-arcana/19-TheSun.png', '19 - O Sol', 'Sim', 'Lorem sol'),
        ('./major-arcana/20-TheJudgement.png', '20 - O Julgamento', 'Sim', 'Explicacao julganto'),
        ('./major-arcana/21-TheWorld.png', '21 - O Mundo', 'Sim', 'Lorem o mundo')
`;
